...
test_that("deprecating warning for select.datatagr()", {
...
test_that("deprecating warning for make_datatagr(x, list())", {

  expect_snapshot(make_datatagr(cars, list(date_onset = "dist", age = "speed")))
